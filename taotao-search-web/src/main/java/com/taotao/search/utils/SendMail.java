...
public class SendMail {
    ...
    public static void sendEmail(String subject,String text) throws MessagingException {
        ...
        //这里填你登录163邮箱所用的用户名
        msg.setFrom(new InternetAddress("864620611@qq.com")); //设置发件人，163邮箱要求发件人与登录用户必须一致（必填），其它邮箱不了解
        ...
        trans.connect("smtp.qq.com", 25, "864620611@qq.com", "sfvpxerpfsflbgaj"); //连接邮箱smtp服务器，25为默认端口
        //要发送到哪个邮箱，这里以qq邮箱为例
        trans.sendMessage(msg, new Address[]{new InternetAddress("864620611@qq.com")}); //发送邮件
    ...
    public static void groupSendEmail(String subject,String content) throws MessagingException {
        ...
        Session session = Session.getInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("864620611@qq.com", "sfvpxerpfsflbgaj");//163邮箱用户名和客户端授权密码（注意，不是登录密码）
            }
        });
        ...
        Message msg = new MimeMessage(session);
        //邮件发送者
        msg.setFrom(new InternetAddress("864620611@qq.com"));
        msg.setSubject(subject);
        //注意第二个参数要写成"text/html;charset=utf-8"，表明这是一封html邮件
        msg.setContent(content, "text/html;charset=utf-8");
        //要群发给哪些邮箱
        msg.setRecipients(MimeMessage.RecipientType.TO, InternetAddress.parse("864620611@qq.com,734077032@qq.com"));
